The extension integrates your Magento 2 based webstore with the **[PayFort](https://www.payfort.com)** payment service.  
...
The extension will be released when somebody provides me an access to the PayFort API. 
...
### 2. Self-installation
```
composer require mage2pro/payfort:*
